...
public class ExchangeRateApi {
    ...
    // Hash map containing key, value pairs of a currency's ISO 4217 three-letter code and its exchange rate
    // to the base currency
    //private Map <String, Double> exchangeRates;

    /* Methods */

    public String getExchangeRateApiKey() { return EXCHANGE_RATE_API_KEY; }

    public void setExchangeRateApiKey(String key) { this.EXCHANGE_RATE_API_KEY = key; }
